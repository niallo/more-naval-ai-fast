...
set DEFINES=/DWIN32 /D_WINDOWS /D_USRDLL /DCVGAMECOREDLL_EXPORTS /DNDEBUG /DLOG_AI /DFINAL_RELEASE /DCUSTOM_PROFILER /DFP_PROFILE_ENABLE /DMNAI_PROFILE_SKIP_TINY_HELPERS /DMNAI_PROFILE_AI_UNIT_VALUE_DETAIL /DMNAI_PROFILE_UNIT_UPDATE_DETAIL /DMNAI_AUTOVERIFY_AUTO_END_TURN /DMNAI_PROFILE_TRUE_COMBAT_CACHE /DMNAI_PROFILE_UPGRADE_LIST_CACHE /DMNAI_PROFILE_PATHVALID_MOVE_CACHE /DMNAI_PROFILE_BASE_BONUS_CACHE /DMNAI_PROFILE_ACTIVE_DANGER_CACHE_SKIP_CLEAN
